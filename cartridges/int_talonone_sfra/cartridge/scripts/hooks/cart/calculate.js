...
exports.calculate = function (basket) {
    ...
    if (TalonOnePreferences.isEnabled()) {
        ...
        // Talonone - Begin: Calling talonone services for each calculate updation
        HookMgr.callHook('dw.order.calculateDiscounts', 'calculateDiscounts', basket);
        // Talonone - End: Calling talonone services for each calculate updation
