...
function start(context) {
    ...
    if (!COBilling.ValidatePayment(cart)) {
        ...
        // Talonone Loyalty - Begin:
        var talonOneHelper = require('*/cartridge/scripts/helper/talonOneHelper');
        var talon = talonOneHelper.talonConfig(false, '', '');
        // Talonone Loyalty - End:
...
function submit() {
    ...
    if (placeOrderResult.error) {
        ...
        var talonOneHelper = require('*/cartridge/scripts/helper/talonOneHelper');
        talonOneHelper.updateCloseOrderSession(placeOrderResult.Order);
...
function showConfirmation(order) {
    ...
    // Talonone - Begin:
    var talonOneHelper = require('*/cartridge/scripts/helper/talonOneHelper');
    var talon = talonOneHelper.talonConfig(true, '', order.custom.referralCode);
    // Talonone - End:
