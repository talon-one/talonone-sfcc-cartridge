...
function handleLoginForm () {
    ...
    loginForm.handleAction({
        login: function () {
            ...
            // Talonone - Begin: Calling the talonone customer profile
            var talonOneHelper = require('*/cartridge/scripts/helper/talonOneHelper');
            talonOneHelper.createCustomerProfile(request.locale);
            // Talonone - End: Calling the talonone customer profile
